    ...
    def run(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            if best_loss > loss_meter.value()[0]:
                ...
                best_epoch = (epoch + 1)
                torch.save(self.model.state_dict(), self.model_path + '/' + 'DomainD-pretrain-best-Res_Unet.pth')

        torch.save(self.model.state_dict(), self.model_path + '/' + 'DomainD-last-Res_Unet.pth')
